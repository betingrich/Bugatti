...
handler.before = async (m, { conn }) => {
  ...
  if (choice === '1') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: botmenu },
      { quoted: fcontact }
    )
  } else if (choice === '2') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: ownermenu },
      { quoted: fcontact }
    )
  } else if (choice === '3') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: groupmenu },
      { quoted: fcontact }
    )
  } else if (choice === '4') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: funmenu },
      { quoted: fcontact }
    )
  } else if (choice === '5') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: reactmenu },
      { quoted: fcontact }
    )
  } else if (choice === '6') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: dlmenu },
      { quoted: fcontact }
    )
  } else if (choice === '7') {
    await conn.sendMessage(
    ...
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: logomenu },
      { quoted: fcontact }
    )
  } else if (choice === '9') {
    await conn.sendMessage(
      m.chat,
      {
        image: { url: 'https://files.catbox.moe/js85tv.jpg' },
        caption: stickermenu,
      },
      { quoted: fcontact }
    )
    ...
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: audiomenu },
      { quoted: fcontact }
    )
  } else if (choice === '11') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: newsmenu },
      { quoted: fcontact }
    )
  } else if (choice === '12') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: economy },
      { quoted: fcontact }
    )
  } else if (choice === '13') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: animemenu },
      { quoted: fcontact }
    )
  } else if (choice === '14') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: nsfwmenu },
      { quoted: fcontact }
    )
  } else if (choice === '15') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: toolsmenu },
      { quoted: fcontact }
    )
  } else if (choice === '16') {
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: Aimenu },
      { quoted: fcontact }
    )
  } else if (choice === '17') {
    await conn.sendMessage(
    ...
    await conn.sendMessage(
      m.chat,
      { image: { url: 'https://files.catbox.moe/js85tv.jpg' }, caption: pluginmenu },
      { quoted: fcontact }
    )
  } else {
