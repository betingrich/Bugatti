...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  ...
  try {
   ...
   if (command === 'play') {
    ...
    const texto1 = `*◉—⌈BUGATTI MUSIC PLAYER⌋—◉*\n❏ 📌 *𝗧𝗶𝘁𝗹𝗲:* ${yt_play[0].title}
...
❏ 🐥*_𝘀𝗲𝗻𝗱𝗶𝗻𝗴 ${additionalText}, 𝗽𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁 𝗮 𝗺𝗼𝗺𝗲𝗻𝘁．．．_*`.trim();
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            await conn.reply(m.chat, '*[🐥] Bugatti is extracting your audio please be patient *', m);
          }
        }
      }
    }
    ...
    throw '*[🐥] Bugatti is extracting your audio please be patient *';
  }
};
